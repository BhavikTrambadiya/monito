...
export default function AppHeader() {
    return (
        <header className="max-w-7xl mx-auto flex justify-between items-center py-[30px] px-2 2xl:px-0">
            ...
            <div className="flex justify-between items-center space-x-3.5">
                <div
                    className="flex justify-start items-center space-x-3 py-3 rounded-full px-4 max-w-[280px]">
